...
/*   Updated: 2023/11/20 11:55:24 by ylachhab         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name){
	std::cout << "Constructor parameterise of ClapTrap called" << std::endl;
	this->_name = name;
	this->_points = 10;
...
void ClapTrap::beRepaired(unsigned int amount) {
	...
	{
		_points += amount;
		std::cout << "ClapTrap " << _name << " recover an amount, its points " << _points << std::endl;
		_energyPoints--;
	}
}
